...
Shader "Universal Render Pipeline/RealToon/Version 5/Default/VertExmotion"
{
    Properties
    {
...
SubShader
{
	...
	Pass {
        ...
        {
			// VertexMotion function
        	input.positionOS.xyz = VertExmotionURP(input.positionOS, input.vertexColor);
...
//DOTS_CompDef(input.vertexID, (float3)_LBS_CD_Position, _LBS_CD_Normal, (float3)_LBS_CD_Tangent);//DOTS_CompDef_OL
    ...
    Pass
    {
        ...
        {
        	// VertexMotion function
        	input.positionOS.xyz = VertExmotionURP(input.positionOS, input.vertexColor, input.normalOS, input.tangentOS);
