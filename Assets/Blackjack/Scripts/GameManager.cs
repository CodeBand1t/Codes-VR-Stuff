...
public class GameManager : MonoBehaviour
{
    ...
    private void DealClicked()
    {
        ...
        pot = 40;
        betsText.text = "Bets: " + pot.ToString() + "cm";
        playerScript.AdjustMoney(-20);
        cashText.text = playerScript.GetMoney().ToString() + "cm";
    ...
    void RoundOver()
    {
        ...
        else if (dealerBust || playerScript.handValue > dealerScript.handValue)
        {
            ...
            Debug.Log($"Player money updated");
        }
        ...
        if (roundOver)
        {
            ...
            // size change
            Debug.Log("Round Over: Scaling now");
            Debug.Log($"Setting User to scale: {playerScript.GetMoney() / 180f}");
            _sizeManager.SetUserLerpTargetScale(playerScript.GetMoney() / 180f);
            _sizeManager.SetUserLerpDuration(pot / 15f);
    ...
    void BetClicked()
    {
        ...
        cashText.text = $"{playerScript.GetMoney()}cm";
        pot += (intBet * 2);
        betsText.text = $"Bets: {pot}cm";
    }
}
